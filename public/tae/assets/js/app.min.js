"use strict";
!function (t) {
    var n = t(window), o = t("body");
    feather.replace({"stroke-width": 1}), t(document).on("click", '[data-toggle="fullscreen"]', function () {
        ...
        var a = t(this), e = a.data("nav-target");
    ...
    if (s.on("show.bs.dropdown", function (a) {
        ...
        var e = t(a.relatedTarget).data("whatever"), n = t(this);
