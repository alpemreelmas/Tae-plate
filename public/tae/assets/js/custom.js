...
(function ($) {
    ...
    $(document).on('click', '.layouts-builder .layouts-builder-toggle', function () {
        $('.layouts-builder').toggleClass('show');
    });

    $(window).on('load', function () {
        setTimeout(function () {
            $('.layouts-builder').removeClass('show');
        }, 500);
    });
    ...
    $('.layouts-builder .layouts-builder-body input[type="radio"][data-layouts="' + $('body').attr('class') + '"]').prop('checked', true);

    $('.layouts-builder .layouts-builder-body input[type="radio"]').click(function () {
        var class_names = '';

        $('.layouts-builder .layouts-builder-body input[type="radio"]:checked').each(function () {
    ...
    $(document).on('click', '#btn-layouts-builder', function () {

    });

    $(document).on('click', '#btn-layouts-builder-reset', function () {
    ...
    $(window).on('load', function () {
        if ($('body').hasClass('horizontal-side-menu') && $(window).width() > 768) {
            if ($('body').hasClass('layouts-container')) {
    ...
    $(document).on('click', '[data-attr="layouts-builder-toggle"]', function () {
        $('.layouts-builder').toggleClass('show');
        return false;
    });
